...
const popupMessageListener = function (msg) {
  ...
  switch (msgType) {
    ...
    case 'shToggle':
      ...
      if (msgBody.multiplier === 0) return sendContentMessage('shEnable', { multiplier: 1 })
...
chrome.runtime.onMessage.addListener(function (msgRaw) {
  ...
  switch (msgType) {
    ...
    case 'queryMemoryResult':
      ...
      if (typeof index !== 'number' || typeof value !== 'number' || !isValidMemType(memType)) {
        return
      }
